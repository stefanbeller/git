...
extern int git_config_rename_section(struct repository *, const char *, const char *);
extern int git_config_rename_section_in_file(const char *, const char *, const char *);
extern int git_config_copy_section(struct repository *, const char *, const char *);
